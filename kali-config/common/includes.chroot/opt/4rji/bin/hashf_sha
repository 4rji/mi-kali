...
WEB_DIR="/etc/shadow"
HASH_FILE="/var/log/hash_file_shadow.txt"
TEMP_HASH_FILE="/tmp/hash_file_shadow_new.txt"





REPORT_FILE="/var/log/shadow_reports.txt"
HISTORICAL_FILE="/var/log/shadow_history.txt"
ALERT_FILE="$HOME/shadow_alerts.log"

FLAG_FILE="/tmp/hash_alert_triggered_shadow"
